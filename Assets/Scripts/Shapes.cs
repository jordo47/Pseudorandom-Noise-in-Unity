...
public static class Shapes {
    ...
    public struct Cylinder : IShape {
        public Point4 GetPoint4 (int i, float resolution, float invResolution) {
            ...
            p.positions.c0 = r * cos(2f * PI * uv.c1);
            p.positions.c1 = uv.c0 - 0.5f;
            p.positions.c2 = r * sin(2f * PI * uv.c1);
            p.normals = p.positions;
    ...
    public struct Job<S>: IJobFor where S : struct, IShape {
        ...
        public static JobHandle ScheduleParallel (
            ...
            float4x4 inv = transpose(inverse(trs));
            return new Job<S> {
                positions = positions,
                normals = normals,
                ...
                normalTRS = float3x4(inv.c0.xyz, inv.c1.xyz, inv.c2.xyz, inv.c3.xyz)
